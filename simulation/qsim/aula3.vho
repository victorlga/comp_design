...
SIGNAL \DECODER|sinais_controle[1]~1_combout\ : std_logic;
SIGNAL \DECODER|sinais_controle[2]~2_combout\ : std_logic;
...
SIGNAL \DECODER|sinais_controle[0]~0_combout\ : std_logic;
...
SIGNAL \DECODER|ALT_INV_sinais_controle[1]~1_combout\ : std_logic;
...
\DECODER|ALT_INV_sinais_controle[1]~1_combout\ <= NOT \DECODER|sinais_controle[1]~1_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \DECODER|sinais_controle[0]~0_combout\,
	devoe => ww_devoe,
	o => \LEDR[6]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \DECODER|sinais_controle[1]~1_combout\,
	devoe => ww_devoe,
	o => \LEDR[7]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \DECODER|sinais_controle[2]~2_combout\,
	devoe => ww_devoe,
	o => \LEDR[8]~output_o\);
...
\DECODER|sinais_controle[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER|sinais_controle[1]~1_combout\ = (!\PC|DOUT\(0) & (!\PC|DOUT\(1) & !\PC|DOUT\(2)))
...
PORT MAP (
	...
	datab => \PC|ALT_INV_DOUT\(1),
	datac => \PC|ALT_INV_DOUT\(2),
	combout => \DECODER|sinais_controle[1]~1_combout\);

\DECODER|sinais_controle[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER|sinais_controle[2]~2_combout\ = !\PC|DOUT\(2) $ (((!\PC|DOUT\(0) & !\PC|DOUT\(1))))
...
PORT MAP (
	...
	datab => \PC|ALT_INV_DOUT\(1),
	datac => \PC|ALT_INV_DOUT\(2),
	combout => \DECODER|sinais_controle[2]~2_combout\);
...
PORT MAP (
	...
	clrn => \DECODER|ALT_INV_sinais_controle[1]~1_combout\,
	ena => \DECODER|sinais_controle[2]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
...
\DECODER|sinais_controle[0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER|sinais_controle[0]~0_combout\ = (!\PC|DOUT\(2) & ((\PC|DOUT\(1)) # (\PC|DOUT\(0))))
...
PORT MAP (
	...
	datab => \PC|ALT_INV_DOUT\(1),
	datac => \PC|ALT_INV_DOUT\(2),
	combout => \DECODER|sinais_controle[0]~0_combout\);
